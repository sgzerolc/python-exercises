...
def test_correlate():
    ...
    test_medium = lab.correlate(image_medium, kernel)
    if test_medium == result_medium:
        return True
    ...
    # test_simple = lab.correlate(image_simple, kernel)
    # if test_simple == result_simple:
    #     return True
    # print(test_simple)
    return False
